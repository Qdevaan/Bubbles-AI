              ...
              child: Row(
                ...
                children: List.generate(3, (i) {
                  if (i < rowActions.length) {
                    ...
                    return const SizedBox(width: 76); // matches width of _QuickActionIconStyle
                  }
                }),
              ),
            );
...
class _QuickActionListTile extends StatefulWidget {
  final IconData icon;
  final Color iconColor;
  final Color iconBg;
  final String title;
  ...
  @override
  State<_QuickActionListTile> createState() => _QuickActionListTileState();
}

class _QuickActionListTileState extends State<_QuickActionListTile> {
  bool _pressed = false;
...
class _QuickActionIconStyle extends StatefulWidget {
  final IconData icon;
  final Color iconColor;
  final Color iconBg;
  final String title;
  ...
  @override
  State<_QuickActionIconStyle> createState() => _QuickActionIconStyleState();
}

class _QuickActionIconStyleState extends State<_QuickActionIconStyle> {
  bool _pressed = false;
